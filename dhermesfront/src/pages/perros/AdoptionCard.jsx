...
const AdoptionCard = ({ gender, imageSrc, name, id }) => {
  return (
    <>
      <div className="max-w-sm overflow-hidden shadow-lg containerCard" style={{ fontFamily: 'Poppins, sans-serif' }}>
        ...
        <div className="px-4 py-4">
          ...
          <div className='flex items-center'>
            <div>
              <svg height="20" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
