...
const HeaderPerros = () => {
  return (
    <>
    <div class="flex items-center filtrosPerros pt-2">
        ...
        <button class='mx-2 pequehidde'>Machos</button>
        <button class='mx-2 pequehidde'>Hembras</button>
        <button class='mx-2 pequehidde'>Cachorros</button>
    </div>
    </>
  );
};
